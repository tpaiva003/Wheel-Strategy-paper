...
class Broker:
    ...
    def find_contract(
        ...
        # Group by expiration; pick the nearest expiration in window
        by_exp: dict = {}
        for c in contracts:
        ...
        # Filter by side relative to target
        def keep(c) -> bool:
...
class Wheel:
    ...
    def reconcile(self) -> None:
        ...
        # If we were tracking an open option, check if it's still open
        ...
        # Stage transitions based on actual share count
    ...
    def tick(self) -> None:
        ...
        # Daily summary near close (within 16 min)
